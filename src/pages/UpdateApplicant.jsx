...
export default function UpdateApplicant() {
  ...
  useEffect(() => {
    // Fetch existing user data based on ID
    async function fetchUserData() {
      try {
        ...
        if (data) {
          ...
          setNameWithInitials(data.name_with_initials);
          ...
          setPractiseCenter(data.practise_center);
          setDepartment(data.department);
          setWorkLocation(data.work_location);
          setMachineNum(data.machine_num);
          setServerNum(data.server_num);
          setWorkerNum(data.worker_num);
          setEpf(data.epf);
